...
//Last modified: Wed, Sep 04, 2019 10:38:14 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 86.456264873845825 55.171642530432898 44.093047366379665 ;
	setAttr ".r" -type "double3" -24.338352729605589 49.000000000003894 2.4239851453288862e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "421955A1-4B13-35B5-97E3-ED9FD7C431CF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 45.060029018864469;
...
createNode transform -n "Main_Camera";
	...
	setAttr ".t" -type "double3" 140.97436365930673 48.640550233407254 64.664574679449316 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" -16.800000000000349 74.400000000000162 0 ;
	setAttr -l on ".rx";
	setAttr -l on ".ry";
	setAttr -l on ".rz";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "973544DC-409C-6FA3-5BC2-C29288BCDA39";
	setAttr -s 63 ".lnk";
	setAttr -s 63 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DD96AA9C-49AF-8C3E-6EBA-99A88A0AAB30";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 0 1 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "77D4BB43-4F15-C7B0-0C32-43BD1B37AE03";
createNode displayLayerManager -n "layerManager";
	rename -uid "64348E68-4BC5-3034-F91A-BABD7FDFEF8C";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C064878B-43C2-E06C-A9FA-D396FFD927E0";
...
createNode reference -n "bedroomRN";
	...
	setAttr ".fn[0]" -type "string" "C:/Users/10668747/Documents/Senior_Kaiju_Film/Snacktime_HoudiniMaya/Scenes/Sets-Environments/bedroom/WIP/bedroom.ma";
...
createNode reference -n "OlderBrother_Rig_01RN";
	...
	setAttr ".fn[0]" -type "string" "C:/Users/10668747/Documents/Senior_Kaiju_Film/Snacktime_HoudiniMaya/Scenes/Characters/Older Brother/03 - Rig/OlderBrother_Rig_01.ma";
	setAttr ".ed" -type "dataReferenceEdits" 
...
createNode reference -n "YoungerBrother_Rig_03___ready_for_skinningRN";
	...
	setAttr ".fn[0]" -type "string" "C:/Users/10668747/Documents/Senior_Kaiju_Film/Snacktime_HoudiniMaya/Scenes/Characters/Younger Brother/04 - Rig/YoungerBrother_Rig_03 - ready for skinning.ma";
	setAttr ".ed" -type "dataReferenceEdits" 
		"YoungerBrother_Rig_03___ready_for_skinningRN"
		"YoungerBrother_Rig_03___ready_for_skinningRN" 0
		"YoungerBrother_Rig_03___ready_for_skinningRN" 13
		...
		"aiTranslator" " -type \"string\" \"polymesh\""
		2 "|YoungerBrother_Rig_03___ready_for_skinning:Master_ctl_grp|YoungerBrother_Rig_03___ready_for_skinning:Master_ctl" 

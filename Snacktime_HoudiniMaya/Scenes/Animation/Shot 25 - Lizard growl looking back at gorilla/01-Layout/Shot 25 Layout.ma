...
//Name: Shot 25 Layout.ma
//Last modified: Mon, Oct 14, 2019 12:21:11 PM
//Codeset: 1252
...
file -rdi 1 -ns "WBCity" -rfn "WBCityRN1" -op "mo=1" -typ "OBJexport" "C:/Users/10703355/Desktop/KaijuRepo/Snacktime_HoudiniMaya//Scenes/Sets-Environments/City/WBCity.obj";
...
file -r -ns "WBCity" -dr 1 -rfn "WBCityRN1" -op "mo=1" -typ "OBJexport" "C:/Users/10703355/Desktop/KaijuRepo/Snacktime_HoudiniMaya//Scenes/Sets-Environments/City/WBCity.obj";
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 32.483741140678234 16.527562720569449 236.88757556541051 ;
	setAttr ".r" -type "double3" -3.338352729566878 -278.99999999997641 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DAC345C1-4D9A-30C4-724C-1BBDDF63290B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 29.454932099844349;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.0013114286348275 28.577710214429921 236.74472958948294 ;
...
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 64.606053835255139;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "788D1F9E-4F65-5F4C-D119-3E8BDB4ECB8B";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "11A0F4D2-4825-7A68-E2AE-14BDEF155608";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B32198BD-462B-9102-F99F-21B54EE687BA";
createNode displayLayerManager -n "layerManager";
	rename -uid "716EE945-4738-CFC6-A48E-9189AFE2F420";
createNode displayLayer -n "defaultLayer";
	rename -uid "A407C3C7-4578-2E46-9023-0D96CB853F1D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5AF34CEB-401B-2122-D8AC-509DCCC7D9F1";
...
createNode reference -n "ZillaRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -0.24728303908750604 0.011725640439458118 1.26040720375160475"
		...
		"translateZ" " -av"
		2 "|Zilla:Zilla|Zilla:Joints|Zilla:L_IK_FR_01_jnt|Zilla:L_IK_FR_02_jnt|Zilla:L_RK_Toe1_01_jnt1" 
		"rotate" " -type \"double3\" -9.81508275985949297 -36.71739360122000306 1.24158207303045409"
		...
		" -type \"double3\" -8.04019617975961509 -1.43430034622507763 6.67449121119317113"
		...
		"rotate" " -type \"double3\" -7.45738338975276616 8.58654574070656551 0.87885811816637915"
		...
		"rotate" " -type \"double3\" -10.41860442096134953 0 0"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Spine_Controls|Zilla:Spine_04_ctl_grp|Zilla:Spine_04_ctl" 
		"rotateX" " -av"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Spine_Controls|Zilla:Spine_04_ctl_grp|Zilla:Spine_04_ctl" 
		"rotateY" " -av"
		...
		"rotate" " -type \"double3\" -23.89982287365691249 13.83541965444235977 -5.43316850673148455"
		...
		"rotate" " -type \"double3\" 0.024355934634280808 3.78808461536685614 -2.89307289004303314"
		...
		"rotate" " -type \"double3\" -20.52810500375934311 8.55748472300896879 -1.98397432877232904"
		...
		"rotate" " -type \"double3\" -16.96133696398138468 23.71824046705614109 -0.67239428586992767"
		...
		"rotate" " -type \"double3\" -1.66220942712278985 13.03650816475688146 -2.82788763738409843"
...
createNode script -n "uiConfigurationScriptNode";
	...
	setAttr ".b" -type "string" (
		...
		+ "                -showNamespace 1\n                -showShapes 1\n                -showSGShapes 0\n                -showTransforms 1\n                -useAssets 1\n                -syncedSelection 1\n                -extendToShapes 1\n                -activeTab -1\n                -editorMode \"default\" \n                $editorName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-userCreated false\n\t\t\t\t-defaultImage \"vacantCell.xP:/\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 50 1 -ps 2 50 1 -ps 3 39 99 -ps 4 61 99 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Top View\")) \n\t\t\t\t\t\"modelPanel\"\n"
...
createNode animCurveTA -n "L_FK_Arm_01_ctl_rotateX";
	...
	setAttr -s 5 ".ktv[0:4]"  1 19.066547518010179 8 19.066547518010179
		 16 19.066547518010179 21 19.066547518010179 34 30.348061567830101;
...
createNode animCurveTA -n "L_FK_Arm_01_ctl_rotateY";
	...
	setAttr -s 5 ".ktv[0:4]"  1 16.618458694743072 8 16.618458694743072
		 16 16.618458694743072 21 16.618458694743072 34 -64.841983420586544;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
createNode animCurveTA -n "L_FK_Arm_01_ctl_rotateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  1
ctl_rotateZ";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 2.2963543144083571 8 2.2963543144083571
		 16 2.2963543144083571 21 2.2963543144083571 34 4.3755302845899022;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
...
createNode animCurveTA -n "Spine_03_ctl_rotateX";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -7.4573833897527662 8 -7.4573833897527662
		 16 -7.4573833897527662 21 -7.4573833897527662 34 -7.4573833897527662;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
createNode animCurveTA -n "Spine_03_ctl_rotateY";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 8.5865457407065655 8 8.5865457407065655
		 16 8.5865457407065655 21 8.5865457407065655 34 8.5865457407065655;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
createNode animCurveTA -n "Spine_03_ctl_rotateZ";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0.87885811816637915 8 0.87885811816637915
		 16 0.87885811816637915 21 0.87885811816637915 34 0.87885811816637915;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
createNode animCurveTA -n "Spine_04_ctl_rotateX";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 8 -7.6745396692442434 16 -17.051725729887643
		 21 -17.051725729887643 34 -15.728122852571166 40 3.2074192301831106;
...
createNode animCurveTA -n "Spine_04_ctl_rotateY";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 8 0 16 0 21 0 34 0.99941304412330156;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
createNode animCurveTA -n "Spine_04_ctl_rotateZ";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 8 0 16 0 21 0 34 29.204330682006258;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
...
createNode animCurveTU -n "R_IK_Leg_01_jnt_ctl_visibility";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 1 8 1 16 1 21 1 34 1;
...
createNode animCurveTU -n "R_Foot_IK_Master_ctl_scaleX";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 4.4684717729273604 8 4.4684717729273604
		 16 4.4684717729273604 21 4.4684717729273604 34 4.4684717729273604;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
...
createNode animCurveTL -n "L_Brow2_ctrl_translateY";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 8 0 16 0 21 8.1878948066105295e-15 34 0;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
...
createNode animCurveTL -n "R_Brow_ctrl_translateY";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 8 0 16 0 21 1 34 1;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
...
createNode animCurveTL -n "L_Brow_ctrl_translateX";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 8 0 16 0 21 -0.98848026411383705 34 -0.98848026411383705;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
createNode animCurveTL -n "L_Brow_ctrl_translateY";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 8 0 16 0 21 0.91710170765568833 34 0.91710170765568833;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
...
createNode animCurveTU -n "Master_ctl_visibility";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 1 8 1 16 1 21 1 32 1;
	setAttr -s 5 ".kit[1:4]"  9 16 16 16;
	setAttr -s 5 ".kot[1:4]"  5 16 16 16;
createNode animCurveTL -n "Master_ctl_translateX";
	...
	setAttr -s 6 ".ktv[0:5]"  1 -0.15553789950801544 8 -0.15553789950801544
		 16 -0.15553789950801544 21 -0.15553789950801544 32 -0.15553789950801544 40 3.0674174107352181;
	setAttr -s 6 ".kit[1:5]"  18 16 16 16 18;
	setAttr -s 6 ".kot[1:5]"  18 16 16 16 18;
...
createNode animCurveTL -n "Master_ctl_translateZ";
	...
	setAttr -s 6 ".ktv[0:5]"  1 247.10251734597705 8 247.10251734597705
		 16 247.10251734597705 21 247.10251734597705 32 247.10251734597705 40 238.87175634483569;
	setAttr -s 6 ".kit[1:5]"  18 16 16 16 18;
	setAttr -s 6 ".kot[1:5]"  18 16 16 16 18;
...
createNode animCurveTL -n "COG_ctl_translateX";
	...
	setAttr -s 5 ".ktv[0:4]"  1 2.1279139130239559 8 2.1279139130239559
		 16 2.1279139130239559 21 2.1279139130239559 34 2.1279139130239559;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
createNode animCurveTL -n "COG_ctl_translateY";
	...
	setAttr -s 5 ".ktv[0:4]"  1 2.4191279381480322 8 2.4191279381480322
		 16 2.4191279381480322 21 2.4191279381480322 34 2.4191279381480322;
	setAttr -s 5 ".kit[1:4]"  18 16 16 16;
	setAttr -s 5 ".kot[1:4]"  18 16 16 16;
...
createNode animCurveTA -n "camera1_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -5.9999999999998304 30 1.2000000000002562;
createNode animCurveTA -n "camera1_rotateY";
	rename -uid "3802749E-4E56-1D05-41C9-F2892BD04B31";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -190.39999999998017 30 -191.59999999998016;
...
createNode animCurveTL -n "camera1_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 9.0560159893637273 30 12.741450215508438;
createNode animCurveTL -n "camera1_translateY";
	rename -uid "EEC2FA7A-4FE6-9600-83D1-A09F2851AD03";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 33.376150361728577 30 26.606879739350166;
createNode animCurveTL -n "camera1_translateZ";
	rename -uid "D3943157-4DEE-0352-838C-D0B6CE3D9751";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 219.68009591588338 30 207.09318947092817;

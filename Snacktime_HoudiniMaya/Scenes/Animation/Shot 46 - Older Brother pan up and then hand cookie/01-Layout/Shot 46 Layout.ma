...
//Last modified: Tue, Sep 17, 2019 08:18:53 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 150.1329921663654 69.09184030590977 63.899991945055177 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 112.22918863588608;
...
createNode transform -n "Main_Camera";
	...
	setAttr ".rpt" -type "double3" 2.4624655864414502e-14 3.4152298769618241e-14 -6.8832386429254201e-14 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7BEAE30C-43B2-F3A8-C332-66B93D18DF16";
	setAttr -s 72 ".lnk";
	setAttr -s 72 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "762923E2-4842-DB95-010B-5982E2A4A8B6";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CE24C48B-40E4-323B-9E1D-409D824AF515";
createNode displayLayerManager -n "layerManager";
	rename -uid "D0E545BF-415A-2DF2-0955-56AFB81499B0";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "409074F2-4796-C10D-3ED6-C9A4DC408F98";
...
createNode reference -n "OlderBrother_Rig_01RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"aiTranslator" " -type \"string\" \"polymesh\""
		2 "|OlderBrother:OIder_Brother|OlderBrother:OlderBrother_Geometry|OlderBrother:OlderBrother_Body_geo|OlderBrother:OlderBrother_Body_geoShape" 
		"aiTranslator" " -type \"string\" \"polymesh\""
		2 "|OlderBrother:OIder_Brother|OlderBrother:OlderBrother_Geometry|OlderBrother:OlderBrother_Body_geo|OlderBrother:OlderBrother_Body_geoShapeOrig" 
		"aiTranslator" " -type \"string\" \"polymesh\""
...
createNode reference -n "YoungerBrother_Rig_03___ready_for_skinningRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"YoungerBrother_Rig_03___ready_for_skinningRN" 58
...
createNode reference -n "sharedReferenceNode";
	rename -uid "A72D1A55-43C0-17C8-3E3B-B88B7D347600";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
createNode animCurveTU -n "Main_Camera_visibility";
	rename -uid "78A9B783-4C94-1736-7DC0-46AF110F5772";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  5;
createNode animCurveTL -n "Main_Camera_translateX";
	rename -uid "6FF7D858-44C0-3135-D564-9EAAC98B2B72";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 56.001135976383026;
createNode animCurveTL -n "Main_Camera_translateY";
	rename -uid "AB7C62FE-4A6B-D0B3-2EE3-12A20D8AE002";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 4.9453536103621563;
createNode animCurveTL -n "Main_Camera_translateZ";
	rename -uid "770370CE-454B-7D4F-64DF-CF95275AA957";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 35.232583538617348;
createNode animCurveTA -n "Main_Camera_rotateX";
	rename -uid "171825F4-4535-3780-A242-2592A2559155";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 23.99999999999876;
createNode animCurveTA -n "Main_Camera_rotateY";
	rename -uid "F75EC98E-4559-5EE6-224A-A4B7CD645E25";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 179.19999999999783;
createNode animCurveTA -n "Main_Camera_rotateZ";
	rename -uid "C6FB4BB9-450B-0033-1467-66911FA65FD6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTU -n "Main_Camera_scaleX";
	rename -uid "22BF1E51-44F8-DDA8-6CC0-7582EB17AD0E";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
createNode animCurveTU -n "Main_Camera_scaleY";
	rename -uid "38483B1A-49AB-EEEF-2D37-C293517CD076";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
createNode animCurveTU -n "Main_Camera_scaleZ";
	rename -uid "38651C9E-4B2B-92EA-6281-738E9063BFA3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
select -ne :time1;

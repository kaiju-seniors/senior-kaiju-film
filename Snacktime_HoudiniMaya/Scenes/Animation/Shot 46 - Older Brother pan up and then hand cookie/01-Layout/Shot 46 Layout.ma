...
//Last modified: Wed, Sep 18, 2019 02:56:58 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 143.90141510494752 30.928053836031069 50.158457135511689 ;
	setAttr ".r" -type "double3" -4.5383527293586807 -280.19999999999072 2.2450795843041445e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "421955A1-4B13-35B5-97E3-ED9FD7C431CF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 82.302802942151885;
...
createNode animCurveTA -n "Main_Camera_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 14.745083553486534 40 35.687719481145187;

...
//Last modified: Tue, Sep 17, 2019 07:42:10 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 159.769669523451 90.385689146238221 136.61274779478009 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 165.28955969682556;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C55313E3-4029-E44C-A8D1-D8A744808119";
	setAttr -s 102 ".lnk";
	setAttr -s 102 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "931D5582-4CD0-DC45-087C-02915DC2016E";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 0 1 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "34942E11-4947-0D4B-D646-318CEE69660C";
createNode displayLayerManager -n "layerManager";
	rename -uid "BABC1E5A-43A3-BDDB-DEC2-4EBAFC77BE1D";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "705A7CFE-4398-FEBF-B8C8-7FBB7E86E4ED";

...
//Last modified: Tue, Sep 17, 2019 08:32:17 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 226.60351523084714 91.469315988769324 80.993179010959764 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 193.71949087954209;
...
createNode transform -n "Main_Camera";
	...
	setAttr ".t" -type "double3" 116.83265340619555 37.407255548039799 50.146435781181914 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B3798F4B-4B44-FABD-450E-7DA86ABD3ACE";
	setAttr -s 108 ".lnk";
	setAttr -s 108 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "22BE44CE-4A84-2CE9-4B04-17AE3CB1E14D";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "25416696-48C1-FEE1-4873-5CB96171CF40";
createNode displayLayerManager -n "layerManager";
	rename -uid "88F2E3EE-40D3-43C8-F491-EA8BFE469F59";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "59DF0F95-4C19-357D-3646-81B51A3A2311";
...
createNode reference -n "OlderBrother_Rig_01RN";
	...
	setAttr ".fn[1]" -type "string" "Z:/KaijuFilmRepo/Snacktime_HoudiniMaya//Scenes/Characters/Older Brother/03 - Rig/OlderBrother_Rig_01.ma";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"aiTranslator" " -type \"string\" \"polymesh\""
		"OlderBrother_Rig_01RN" 26
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:COG_ctl_grp|OlderBrother:COG_ctl" 
		"translate" " -type \"double3\" 0 -8.14713036914983135 0.66700906010866845"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:COG_ctl_grp|OlderBrother:COG_ctl" 
		"rotate" " -type \"double3\" 13.43646648590261528 0 0"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Master_ctl_grp|OlderBrother:Master_ctl" 
		"translate" " -type \"double3\" 53.50354267847436063 0 44.29467093520494814"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Master_ctl_grp|OlderBrother:Master_ctl" 
...
createNode reference -n "sharedReferenceNode";
	rename -uid "02678412-4D8D-2CFF-A698-37B034BBEC05";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
select -ne :time1;
	setAttr ".o" 1;

...
//Last modified: Tue, Dec 03, 2019 01:44:50 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -198.5366817857128 58.959734627860101 190.43185740140149 ;
	setAttr ".r" -type "double3" -8.1383527298314213 662.20000000007815 7.460818824843097e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DAC345C1-4D9A-30C4-724C-1BBDDF63290B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 237.34524620742403;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7F66EAAA-43B1-1DB1-044D-E48E24E944F3";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BF118DF4-486B-B1B7-AA3D-0BB912C96931";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DB52FBD1-426D-440E-2AC3-E8AC22C778B6";
createNode displayLayerManager -n "layerManager";
	rename -uid "ED5445FD-4365-8C77-061F-93A0EA9608D0";
createNode displayLayer -n "defaultLayer";
	rename -uid "A407C3C7-4578-2E46-9023-0D96CB853F1D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DBF02018-4142-5A34-B3DF-67B9F0B45D33";
...
connectAttr "L_FK_Arm_03_ctl_translateX.o" "KongRN.phl[30]";
connectAttr "L_FK_Arm_03_ctl_translateY.o" "KongRN.phl[31]";
connectAttr "L_FK_Arm_03_ctl_translateZ.o" "KongRN.phl[32]";
connectAttr "L_FK_Arm_03_ctl_rotateX.o" "KongRN.phl[33]";
connectAttr "L_FK_Arm_03_ctl_rotateY.o" "KongRN.phl[34]";
connectAttr "L_FK_Arm_03_ctl_rotateZ.o" "KongRN.phl[35]";
connectAttr "L_FK_Arm_03_ctl_scaleX.o" "KongRN.phl[36]";
connectAttr "L_FK_Arm_03_ctl_scaleY.o" "KongRN.phl[37]";
connectAttr "L_FK_Arm_03_ctl_scaleZ.o" "KongRN.phl[38]";
connectAttr "L_FK_Arm_03_ctl_Follow_Translates.o" "KongRN.phl[39]";
connectAttr "L_FK_Arm_03_ctl_Follow_Rotates.o" "KongRN.phl[40]";

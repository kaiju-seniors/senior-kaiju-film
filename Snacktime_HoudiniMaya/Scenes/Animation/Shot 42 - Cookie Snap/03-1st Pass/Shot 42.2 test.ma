...
//Name: Shot 42.2 test.ma
//Last modified: Sat, Nov 09, 2019 10:34:22 PM
//Codeset: 1252
...
createNode transform -n "Main_Camera" -p "group1";
	...
	setAttr ".t" -type "double3" 66.94537314079291 40.341721460843061 87.680717326035563 ;
	setAttr -av ".tx";
	setAttr -av ".ty";
	setAttr -av ".tz";
	setAttr ".r" -type "double3" -86.179073701524217 -457.56321933162036 -7.6333312355124402e-14 ;
	setAttr -av ".rx";
	setAttr -av ".ry";
	setAttr -av ".rz";
...
createNode fosterParent -n "CookiePrincessRNfosterParent1";
	rename -uid "115F1047-4798-EDFB-C6D4-DAA45E91ED56";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "508D7FD3-45A4-6E66-6634-DB8906EAE5DB";
	setAttr -s 65 ".lnk";
	setAttr -s 65 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4123397C-42F3-17BB-D626-3BA92F12EA95";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B825C550-4CF5-1699-8E83-E3B662FBC849";
createNode displayLayerManager -n "layerManager";
	rename -uid "284EDED1-41BC-332A-AB47-4AB32C288044";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F4712B08-4576-5E12-9087-0CBBFBF79901";
...
createNode reference -n "OlderBrother_Rig_01RN";
	...
	setAttr ".fn[2]" -type "string" "C:/Users/Spencer/Documents/10487246/senior-kaiju-film/Snacktime_HoudiniMaya//Scenes/Characters/Older Brother/03 - Rig/OlderBrother_Rig_02.ma";
	setAttr ".fn[3]" -type "string" "C:/Users/Spencer/Documents/10487246/senior-kaiju-film/Snacktime_HoudiniMaya//Scenes/Characters/Older Brother/03 - Rig/OlderBrother_Rig_01.ma";
	setAttr -s 704 ".phl";
	setAttr ".phl[195]" 0;
	setAttr ".phl[198]" 0;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 14 -max 72 -ast 1 -aet 200 ";
	setAttr ".st" 6;
...
createNode animCurveTA -n "L_FK_Arm_03_ctl_rotateZ";
	...
	setAttr -s 8 ".ktv[0:7]"  1 -17.618213715804973 12 -34.722045096568849
		 ...
		 53 -11.442057087404622 72 -11.803866303131789;
	setAttr -s 8 ".kit[1:7]"  1 18 1 18 1 18 18;
	setAttr -s 8 ".kot[1:7]"  1 18 1 18 1 18 18;

...
//Name: Shot 42 Blocking Pass.ma
//Last modified: Wed, Oct 02, 2019 09:14:59 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 56.707663907048314 54.200445199203784 84.596080642682637 ;
	setAttr ".r" -type "double3" -65.738352742141757 -821.39999999670977 2.5444437451708134e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "421955A1-4B13-35B5-97E3-ED9FD7C431CF";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 29.209289070865147;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "18C4154F-4D94-3D2E-9987-F1A376C9661B";
	setAttr -s 64 ".lnk";
	setAttr -s 64 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6945C80B-451F-E187-4CE1-FBA26740BC3B";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2983E68E-4AE2-D025-7304-E3BF0DF3C409";
createNode displayLayerManager -n "layerManager";
	rename -uid "CCCA0360-4E02-BB43-BDDD-90BEA86F9EEC";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "48C8A923-4BDC-26F7-4453-E49EE304C313";
...
createNode reference -n "OlderBrother_Rig_01RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -0.042596245312585733 0.60108840098802685 0"
		...
		"translateZ" " -av"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Controls1|OlderBrother:R_Arm_FK_Controls|OlderBrother:R_FK_Arm_02_ctl_grp|OlderBrother:R_FK_Arm_02_ctl" 
		"rotate" " -type \"double3\" 72.6193692737851535 32.85489691786136746 5.51903063285224427"
		...
		"translateZ" " -av"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Controls1|OlderBrother:R_Arm_FK_Controls|OlderBrother:R_FK_Arm_03_ctl_grp|OlderBrother:R_FK_Arm_03_ctl" 
		"rotate" " -type \"double3\" 30.82746949348969423 -16.45212341140255319 7.4958145162918397"
		...
		"rotate" " -type \"double3\" 0 20.57658562259906532 0"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Controls1|OlderBrother:R_Arm_FK_Controls|OlderBrother:R_FK_Finger1_02_ctl_grp|OlderBrother:R_FK_Finger1_02_ctl" 
		"rotateX" " -av"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Controls1|OlderBrother:R_Arm_FK_Controls|OlderBrother:R_FK_Finger1_02_ctl_grp|OlderBrother:R_FK_Finger1_02_ctl" 
		"rotateY" " -av"
		...
		"translateZ" " -av"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Controls|OlderBrother:L_Arm_FK_Controls|OlderBrother:L_FK_Arm_02_ctl_grp|OlderBrother:L_FK_Arm_02_ctl" 
		"rotate" " -type \"double3\" -17.62297152977815529 -67.35537086990892419 -12.32996061063757054"
		...
		"translateZ" " -av"
		2 "|OlderBrother:OIder_Brother|OlderBrother:Controls|OlderBrother:Controls|OlderBrother:L_Arm_FK_Controls|OlderBrother:L_FK_Arm_03_ctl_grp|OlderBrother:L_FK_Arm_03_ctl" 
		"rotate" " -type \"double3\" -39.55202723329212944 20.97344051595635861 -12.33211970787535172"
...
createNode reference -n "YoungerBrother_Rig_03___ready_for_skinningRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"aiTranslator" " -type \"string\" \"polymesh\""
		"YoungerBrother_Rig_03___ready_for_skinningRN" 6
...
createNode animCurveTA -n "R_FK_Arm_02_ctl_rotateX";
	...
	setAttr -s 4 ".ktv[0:3]"  1 -41.654650986100698 25 -41.654650986100698
		 36 28.80577123796342 45 72.619369273785153;
	setAttr -s 4 ".kit[3]"  1;
	setAttr -s 4 ".kot[3]"  1;
	setAttr -s 4 ".kix[3]"  1;
	setAttr -s 4 ".kiy[3]"  0;
...
createNode animCurveTA -n "R_FK_Arm_02_ctl_rotateY";
	...
	setAttr -s 4 ".ktv[0:3]"  1 32.854896917861318 25 32.854896917861318
		 36 32.854896917861346 45 32.854896917861367;
	setAttr -s 4 ".kit[3]"  1;
	setAttr -s 4 ".kot[3]"  1;
	setAttr -s 4 ".kix[3]"  1;
	setAttr -s 4 ".kiy[3]"  0;
...
createNode animCurveTA -n "R_FK_Arm_02_ctl_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  1 5.5190306328522638 25 5.5190306328522638
		 36 5.5190306328522682 45 5.5190306328522443;
	setAttr -s 4 ".kit[3]"  1;
	setAttr -s 4 ".kot[3]"  1;
	setAttr -s 4 ".kix[3]"  1;
	setAttr -s 4 ".kiy[3]"  0;
...
createNode animCurveTA -n "R_FK_Arm_03_ctl_rotateX";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 3.5317949948951375 12 -24.852233119086556
		 17 30.827469493489694;
...
createNode animCurveTA -n "R_FK_Arm_03_ctl_rotateY";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -1.4566990870182963 12 -1.808779139553071
		 17 -16.452123411402553;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  18 1 1;
	setAttr -s 3 ".kix[1:2]"  0.99988364078815539 1;
	setAttr -s 3 ".kiy[1:2]"  -0.015254667620869166 0;
	setAttr -s 3 ".kox[1:2]"  0.99988364078815528 1;
	setAttr -s 3 ".koy[1:2]"  -0.015254667620869165 0;
createNode animCurveTA -n "R_FK_Arm_03_ctl_rotateZ";
	rename -uid "A01DD7FC-4FD7-32B0-45B2-F6B9EEDAE7A7";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -2.4095251900608874 12 -17.851399858760885
		 17 7.4958145162918397;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  18 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
...
createNode animCurveTA -n "R_FK_Finger1_02_ctl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 20.576585622599065;
...
createNode animCurveTA -n "L_FK_Arm_02_ctl_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  1 -12.329960610637537 25 -12.329960610637537
		 33 -12.329960610637578 48 -12.329960610637571;
createNode animCurveTA -n "L_FK_Arm_03_ctl_rotateX";
	rename -uid "5D030135-4D02-857E-914C-93B7D2219CF0";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -1.3095136013858975 12 10.050216095194358
		 20 -39.552027233292129;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  18 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
...
createNode animCurveTA -n "L_FK_Arm_03_ctl_rotateY";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 6.6640704924460525 12 -3.2805311569611537
		 20 20.973440515956359;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  18 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
...
createNode animCurveTA -n "L_FK_Arm_03_ctl_rotateZ";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -17.618213715804973 12 -34.722045096568849
		 20 -12.332119707875352;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  18 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
...
createNode animCurveTL -n "L_FK_Arm_02_ctl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 25 0 33 0 48 0;
...
createNode animCurveTU -n "R_FK_Arm_03_ctl_visibility";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 12 1 17 1;
	setAttr -s 3 ".kit[0:2]"  9 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
createNode animCurveTL -n "R_FK_Arm_03_ctl_translateX";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 12 0 17 0;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  18 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
...
createNode animCurveTL -n "R_FK_Arm_02_ctl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 25 0 36 0 45 0;
	setAttr -s 4 ".kit[3]"  1;
	setAttr -s 4 ".kot[3]"  1;
	setAttr -s 4 ".kix[3]"  1;
	setAttr -s 4 ".kiy[3]"  0;
...
connectAttr "L_FK_Finger5_03_ctl_translateZ.o" "OlderBrother_Rig_01RN.phl[1833]"
		;
connectAttr "L_FK_Finger5_03_ctl_rotateZ.o" "OlderBrother_Rig_01RN.phl[1834]";
connectAttr "L_FK_Finger5_03_ctl_rotateX.o" "OlderBrother_Rig_01RN.phl[1835]";
connectAttr "L_FK_Finger5_03_ctl_rotateY.o" "OlderBrother_Rig_01RN.phl[1836]";
...
// End of Shot 42 Blocking Pass.ma

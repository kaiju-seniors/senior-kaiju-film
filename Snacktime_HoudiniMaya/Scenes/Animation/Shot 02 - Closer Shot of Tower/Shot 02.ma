...
//Name: Shot 02.ma
//Last modified: Mon, Oct 14, 2019 11:30:14 AM
//Codeset: 1252
...
file -rdi 1 -ns "Cathedral" -rfn "CathedralRN" -op "fbx" -typ "FBX export" "C:/Users/10703355/Desktop/KaijuRepo/Snacktime_HoudiniMaya//Scenes/Sets-Environments/City/Cathedral.fbx";
...
file -rdi 1 -ns "PrincessTower" -dr 1 -rfn "PrincessTowerRN1" -op "mo=1" -typ
		 "OBJexport" "C:/Users/10703355/Desktop/KaijuRepo/City Generator/PrincessTower.obj";
...
file -r -ns "Cathedral" -dr 1 -rfn "CathedralRN" -op "fbx" -typ "FBX export" "C:/Users/10703355/Desktop/KaijuRepo/Snacktime_HoudiniMaya//Scenes/Sets-Environments/City/Cathedral.fbx";
...
file -r -ns "PrincessTower" -dr 1 -rfn "PrincessTowerRN1" -op "mo=1" -typ "OBJexport"
		 "C:/Users/10703355/Desktop/KaijuRepo/City Generator/PrincessTower.obj";
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 173.73959320516536 56.945412320594031 116.09343312134729 ;
	setAttr ".r" -type "double3" -8.1383527295923628 59.800000000004502 -7.9036495042858111e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DAC345C1-4D9A-30C4-724C-1BBDDF63290B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 212.79320037081357;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "82F10673-4935-B468-6D9C-BFBBEE44B14C";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "ED535BCA-4DCB-AD09-0A6E-B48EA4674245";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D7322217-48D7-6803-B76E-6B85D82BA841";
createNode displayLayerManager -n "layerManager";
	rename -uid "14E3811B-47E6-1954-9229-D4A9CCF4F0BC";
createNode displayLayer -n "defaultLayer";
	rename -uid "A407C3C7-4578-2E46-9023-0D96CB853F1D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "630DDDFD-40E9-D9BF-BE20-E38610D2F19A";
...
createNode script -n "uiConfigurationScriptNode";
	...
	setAttr ".b" -type "string" (
		...
		+ "                -showNamespace 1\n                -showShapes 1\n                -showSGShapes 0\n                -showTransforms 1\n                -useAssets 1\n                -syncedSelection 1\n                -extendToShapes 1\n                -activeTab -1\n                -editorMode \"default\" \n                $editorName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-userCreated false\n\t\t\t\t-defaultImage \"vacantCell.xP:/\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 50 1 -ps 2 50 1 -ps 3 36 99 -ps 4 64 99 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Top View\")) \n\t\t\t\t\t\"modelPanel\"\n"
...
createNode reference -n "CathedralRN";
	rename -uid "4BB05B21-4615-71BC-4BFC-218D27C3FCA3";
	setAttr ".ed" -type "dataReferenceEdits" 
		"CathedralRN"
		"CathedralRN" 0;
	setAttr ".ptag" -type "string" "";
...
createNode reference -n "WBCityRN1";
	rename -uid "DC0C81EB-44BF-FDDA-ECEB-27A7FD906D45";
	setAttr ".ed" -type "dataReferenceEdits" 
		"WBCityRN1"
		"WBCityRN1" 0;
	setAttr ".ptag" -type "string" "";
...
createNode reference -n "PrincessTowerRN1";
	rename -uid "190C38EF-4CB2-0EC7-85BE-698917BDB3A1";
	setAttr ".ed" -type "dataReferenceEdits" 
		"PrincessTowerRN1"
		"PrincessTowerRN1" 0;
lockNode -l 1 ;
createNode reference -n "sharedReferenceNode";
	rename -uid "C2F06ABC-42C4-0AE4-F7C7-C187DB868276";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
createNode animCurveTU -n "camera1_visibility";
	rename -uid "6EC5803D-4FE4-E828-6627-5CA6E5FFA63D";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  5;
createNode animCurveTL -n "camera1_translateX";
	rename -uid "58E62507-4736-0051-1E96-CDAC9159191C";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 40.933202846362782 43 31.232158353216786;
createNode animCurveTL -n "camera1_translateY";
	rename -uid "20E255C3-454F-FBEF-7D74-889390D91C5F";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 20.063636788159574 43 20.831985128482284;
createNode animCurveTL -n "camera1_translateZ";
	rename -uid "D6B42086-44D1-430D-ED79-16BF9AB7B446";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 24.469622786861105 43 20.550146393636531;
createNode animCurveTA -n "camera1_rotateX";
	rename -uid "D4441E7A-44E8-1074-319C-6380FC0E484A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 4.1999999999997693;
createNode animCurveTA -n "camera1_rotateY";
	rename -uid "28056BD6-4E48-3EDE-497E-4FACDAD619CC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 68.000000000000682;
createNode animCurveTA -n "camera1_rotateZ";
	rename -uid "B229EC48-4583-EBC0-B1EB-97A230EC96BA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTU -n "camera1_scaleX";
	rename -uid "13FE0904-45A9-9B3E-663F-A78096D39026";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
createNode animCurveTU -n "camera1_scaleY";
	rename -uid "1BF19142-4F1E-E4E8-B958-DA9580CF4A79";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
createNode animCurveTU -n "camera1_scaleZ";
	rename -uid "C970EFB8-4925-6109-A050-868184C56BCE";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
select -ne :time1;
...
connectAttr "sharedReferenceNode.sr" "PrincessTowerRN1.sr";

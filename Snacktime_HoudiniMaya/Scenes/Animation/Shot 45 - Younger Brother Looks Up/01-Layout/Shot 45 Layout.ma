...
//Last modified: Tue, Sep 17, 2019 08:04:34 PM
//Codeset: 1252
...
createNode transform -n "Main_Camera";
	...
	setAttr ".t" -type "double3" 57.956820331731024 34.560552137086553 61.052236680872028 ;
	setAttr ".r" -type "double3" -31.800000000001443 -8.4640604444299124e-16 -6.8933570906000689e-17 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A78DC19D-4275-6177-985A-86A0295C39F7";
	setAttr -s 72 ".lnk";
	setAttr -s 72 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "28A25239-4087-E3B9-D9DB-5492AA807F8C";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "11945FD8-497F-EC02-8B28-EAA07329C57B";
createNode displayLayerManager -n "layerManager";
	rename -uid "D98D9640-4EAA-F22C-7376-E1BC94114E13";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D2FC3499-4624-2415-EC25-C48830DEB46E";

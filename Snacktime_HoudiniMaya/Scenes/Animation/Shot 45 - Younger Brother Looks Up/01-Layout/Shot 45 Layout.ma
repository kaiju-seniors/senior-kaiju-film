...
//Name: Shot 45 Layout.ma
//Last modified: Tue, Sep 17, 2019 05:47:51 PM
//Codeset: 1252
...
createNode transform -n "Main_Camera";
	...
	setAttr ".t" -type "double3" 54.416611019601341 26.111285840372972 46.179281763755021 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" -25.800000000001212 0 0 ;
	setAttr -l on ".rx";
	setAttr -l on ".ry";
	setAttr -l on ".rz";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D8A1AAFE-4AD0-2ABE-E053-73AE832D6759";
	setAttr -s 43 ".lnk";
	setAttr -s 43 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D201C75F-425A-4516-EF3D-D1AE980F19BC";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 0 1 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6A89B495-4067-9664-308C-1B97C20D6DCB";
createNode displayLayerManager -n "layerManager";
	rename -uid "F79D0706-49F8-CA02-4DF9-CEBBBDD1EC6D";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B45C0BAF-41D5-A4A3-4966-C188ED9F989A";

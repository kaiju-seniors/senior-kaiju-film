...
//Name: Shot 13 Layout.ma
//Last modified: Mon, Oct 07, 2019 02:30:03 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.333652077388816 27.916201204839673 278.59107318137967 ;
	setAttr ".r" -type "double3" -4.5383527295745081 -8.9999999999976907 5.0315635869430623e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DAC345C1-4D9A-30C4-724C-1BBDDF63290B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 282.40716883254396;
...
createNode animCurveTA -n "camera1_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -3 120 -4.2000000000000437;
...
createNode animCurveTA -n "camera1_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -1.016128176577578e-16 120 -1.0984677516532098e-16;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;

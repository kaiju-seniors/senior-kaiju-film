...
//Name: Shot 11 Blocked Animation.ma
//Last modified: Thu, Oct 10, 2019 04:16:02 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -99.746915945003678 25.381883493978748 67.58671659624838 ;
	setAttr ".r" -type "double3" -9.9383527300938237 269.00000000001444 -7.6333312355124402e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DAC345C1-4D9A-30C4-724C-1BBDDF63290B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 98.839074238054437;
...
createNode reference -n "KongRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translateZ" " -av"
		2 "|Kong:Kong|Kong:Controls|Kong:Spine_06_ctl_grp|Kong:Neck_Offset|Kong:Neck_01_Master_rotate_ctrl|Kong:Spine_06_ctl" 
		"rotate" " -type \"double3\" -21.4949564603633938 -81.27948540601774141 19.99999999999994316"
		...
		" -type \"double3\" -16.75070049535078454 0 14.98882605333201923"
...
createNode animCurveTL -n "COG_ctl_translateX";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  1 -1.8993657674750264 13 -2.4411934154230024
		 30 -1.8163521607797493 40 -2.596225350124941;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
	setAttr -s 4 ".kix[0:3]"  1.0416666666666665 0.49999999999999994 
		0.70833333333333337 0.58333333333333326;
	setAttr -s 4 ".kiy[0:3]"  0 0 0 0;
	setAttr -s 4 ".kox[0:3]"  1.0416666666666665 0.70833333333333337 
		0.41666666666666674 0.58333333333333326;
	setAttr -s 4 ".koy[0:3]"  0 0 0 0;
createNode animCurveTL -n "COG_ctl_translateY";
	rename -uid "92FBDA84-4659-F16E-161F-1D8C10311DFE";
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  1 -0.27647323957267944 13 -0.35534211658595788
		 30 -0.26438971086816476 40 -0.37790869220729439;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
	setAttr -s 4 ".kix[0:3]"  1.0416666666666665 0.49999999999999994 
		0.70833333333333337 0.58333333333333326;
...
createNode animCurveTL -n "COG_ctl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  1 2.1183580501373394e-15 13 1.4365817246292104e-15
		 30 1.4280784139058992e-15 40 -9.7007496572386095e-15;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
	setAttr -s 4 ".kix[0:3]"  1.0416666666666665 0.49999999999999994 
		0.70833333333333337 0.58333333333333326;
...
createNode animCurveTU -n "COG_ctl_visibility";
	...
	setAttr ".tan" 5;
	setAttr -s 4 ".ktv[0:3]"  1 1 13 1 30 1 40 1;
...
createNode animCurveTA -n "COG_ctl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  1 0 13 0 30 0 40 0;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
	setAttr -s 4 ".kix[0:3]"  1.0416666666666665 0.49999999999999994 
		0.70833333333333337 0.58333333333333326;
...
createNode animCurveTA -n "COG_ctl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  1 -18.198371239202967 13 -18.198371239202967
		 30 -18.198371239202967 40 -18.198371239202967;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
	setAttr -s 4 ".kix[0:3]"  1.0416666666666665 0.49999999999999994 
		0.70833333333333337 0.58333333333333326;
...
createNode animCurveTL -n "Spine_06_ctl_translateX";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  1 0 10 0 38 0;
	setAttr -s 3 ".kit[0:2]"  1 18 18;
	setAttr -s 3 ".kot[0:2]"  1 18 18;
	setAttr -s 3 ".kix[0:2]"  0.54166666666666652 0.375 1.1666666666666665;
...
createNode animCurveTU -n "Spine_06_ctl_visibility";
	...
	setAttr ".tan" 5;
	setAttr -s 3 ".ktv[0:2]"  1 1 10 1 38 1;
...
createNode animCurveTA -n "Spine_06_ctl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  1 -21.494956460363394 10 -5.4563995854619751
		 38 -4.305115211552506;
	setAttr -s 3 ".kit[0:2]"  1 18 18;
	setAttr -s 3 ".kot[0:2]"  1 18 18;
	setAttr -s 3 ".kix[0:2]"  0.54166666666666652 0.375 1.1666666666666665;
	setAttr -s 3 ".kiy[0:2]"  0 0.01937607070321453 0;
	setAttr -s 3 ".kox[0:2]"  0.54166666666666652 1.1666666666666665 
		1.1666666666666665;
	setAttr -s 3 ".koy[0:2]"  0 0.060281108854445195 0;
createNode animCurveTA -n "Spine_06_ctl_rotateY";
	rename -uid "C284748B-4E6C-DCAA-0D0E-328AD4EC1902";
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  1 -81.279485406017741 10 -48.62380549562414
		 38 42.26355379317674;
	setAttr -s 3 ".kit[0:2]"  1 18 18;
	setAttr -s 3 ".kot[0:2]"  1 18 18;
	setAttr -s 3 ".kix[0:2]"  0.54166666666666652 0.375 1.1666666666666665;
	setAttr -s 3 ".kiy[0:2]"  0 0.52448905993289896 0;
	setAttr -s 3 ".kox[0:2]"  0.54166666666666652 1.1666666666666665 
		1.1666666666666665;
	setAttr -s 3 ".koy[0:2]"  0 1.6317437420134633 0;
createNode animCurveTA -n "Spine_06_ctl_rotateZ";
	rename -uid "1580F268-4C26-329B-4405-F58049E74477";
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  1 19.999999999999943 10 -2.3109592687834781
		 38 -4.1671423421198712;
	setAttr -s 3 ".kit[0:2]"  1 18 18;
	setAttr -s 3 ".kot[0:2]"  1 18 18;
	setAttr -s 3 ".kix[0:2]"  0.54166666666666652 0.375 1.1666666666666665;
	setAttr -s 3 ".kiy[0:2]"  0 -0.031239488072739314 0;
	setAttr -s 3 ".kox[0:2]"  0.54166666666666652 1.1666666666666665 
		1.1666666666666665;
	setAttr -s 3 ".koy[0:2]"  0 -0.097189518448522291 0;
createNode animCurveTU -n "Spine_06_ctl_scaleX";
	rename -uid "DCDAF263-446B-65CD-5887-25B281BD86E7";
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  1 0.999999999999999 10 0.999999999999999
...
createNode animCurveTU -n "Spine_06_ctl_scaleY";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  1 0.99999999999999967 10 0.99999999999999967
		 38 0.99999999999999967;
	setAttr -s 3 ".kit[0:2]"  1 18 18;
	setAttr -s 3 ".kot[0:2]"  1 18 18;
	setAttr -s 3 ".kix[0:2]"  0.54166666666666652 0.375 1.1666666666666665;
	setAttr -s 3 ".kiy[0:2]"  0 0 0;
...
createNode animCurveTU -n "Spine_06_ctl_scaleZ";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  1 0.99999999999999978 10 0.99999999999999978
		 38 0.99999999999999978;
	setAttr -s 3 ".kit[0:2]"  1 18 18;
	setAttr -s 3 ".kot[0:2]"  1 18 18;
	setAttr -s 3 ".kix[0:2]"  0.54166666666666652 0.375 1.1666666666666665;
	setAttr -s 3 ".kiy[0:2]"  0 0 0;
...
createNode animCurveTA -n "Spine_04_ctl_rotateX";
	...
	setAttr ".tan" 1;
	setAttr -s 2 ".ktv[0:1]"  1 -16.750700495350785 32 1.7515146799565191;
	setAttr -s 2 ".kit[1]"  18;
	setAttr -s 2 ".kot[1]"  18;
	setAttr -s 2 ".kix[0:1]"  0.75 1.2916666666666665;
	setAttr -s 2 ".kiy[0:1]"  0 0;
	setAttr -s 2 ".kox[0:1]"  0.75 1.2916666666666665;
	setAttr -s 2 ".koy[0:1]"  0 0;
createNode animCurveTA -n "Spine_04_ctl_rotateY";
	rename -uid "EAC2A685-41FA-3CAA-6D95-D6830D0C72F3";
	setAttr ".tan" 1;
	setAttr -s 2 ".ktv[0:1]"  1 0 32 -4.9696166897867474e-17;
	setAttr -s 2 ".kit[1]"  18;
	setAttr -s 2 ".kot[1]"  18;
	setAttr -s 2 ".kix[0:1]"  0.75 1.2916666666666665;
	setAttr -s 2 ".kiy[0:1]"  0 0;
...
createNode animCurveTA -n "Spine_04_ctl_rotateZ";
	...
	setAttr ".tan" 1;
	setAttr -s 2 ".ktv[0:1]"  1 14.988826053332019 32 14.988826053332023;
	setAttr -s 2 ".kit[1]"  18;
	setAttr -s 2 ".kot[1]"  18;
	setAttr -s 2 ".kix[0:1]"  0.75 1.2916666666666665;
	setAttr -s 2 ".kiy[0:1]"  0 0;
...
createNode animCurveTA -n "Spine_02_ctl_rotateX";
	...
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  1 -15.903706382337587;
	setAttr ".kix[0]"  0.54166666666666652;
	setAttr ".kiy[0]"  0;
	setAttr ".kox[0]"  0.54166666666666652;
	setAttr ".koy[0]"  0;
...
createNode animCurveTA -n "Spine_02_ctl_rotateZ";
	...
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  1 0.29663278238296381;
	setAttr ".kix[0]"  0.54166666666666652;
	setAttr ".kiy[0]"  0;
	setAttr ".kox[0]"  0.54166666666666652;
	setAttr ".koy[0]"  0;
...
// End of Shot 11 Blocked Animation.ma

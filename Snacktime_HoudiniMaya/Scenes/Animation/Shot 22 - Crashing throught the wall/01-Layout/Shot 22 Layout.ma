...
//Name: Shot 22 Layout.ma
//Last modified: Mon, Oct 07, 2019 02:56:53 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -125.48396166108169 58.098770285184997 361.02320439534748 ;
	setAttr ".r" -type "double3" -17.138352729574578 -51.799999999997702 -2.5715649280799357e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DAC345C1-4D9A-30C4-724C-1BBDDF63290B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 363.57990616502963;
...
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 148.67886775672991;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "3F390C6D-43FE-B436-9C70-258CE8F0050B";
	setAttr -s 10 ".lnk";
	setAttr -s 10 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "45748DB5-48E1-1A98-3D9E-EE81AE63D55C";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "30D1D09E-4879-A9D4-94DB-8B89D464EF29";
createNode displayLayerManager -n "layerManager";
	rename -uid "DD4A89FD-4B82-F0AB-5CF5-C591D19BCF84";
createNode displayLayer -n "defaultLayer";
	rename -uid "A407C3C7-4578-2E46-9023-0D96CB853F1D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D242C6EF-450D-D262-F4CD-0499CA50F3A7";
...
createNode reference -n "ZillaRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -0.24731238243921894 0.011736437275631673 1.26044409286885184"
		...
		"translateZ" " -av"
		2 "|Zilla:Zilla|Zilla:Joints|Zilla:L_IK_FR_01_jnt|Zilla:L_IK_FR_02_jnt|Zilla:L_RK_Toe1_01_jnt1" 
		"rotate" " -type \"double3\" -9.81505191529086929 -36.71625256954231276 1.24122959359273222"
		...
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Controls2|Zilla:R_Leg_IK_Controls|Zilla:R_Leg_PV_ctl_grp|Zilla:R_Leg_PV_ctl" 
		"translate" " -type \"double3\" -14.12151467992399567 -18.31589958443854016 13.81039219518859262"
		
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Controls2|Zilla:R_Leg_IK_Controls|Zilla:R_IK_Foot_controls|Zilla:R_Foot_IK_Master_ctl_grp|Zilla:R_Foot_IK_Master_ctl" 
		"translate" " -type \"double3\" 0 0 0"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Controls1|Zilla:L_Leg_IK_Controls|Zilla:L_Leg_PV_Ctl_grp|Zilla:L_Leg_PV_Ctl" 
...
createNode animCurveTL -n "camera1_translateX";
	rename -uid "A377540E-4BC2-1898-B5CB-9383E4C8CCC7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -32.249141371992458 120 -29.750812539408564;
createNode animCurveTL -n "camera1_translateY";
	rename -uid "4BA6AEDE-4EA6-A277-D428-0DA5661B0BD6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 40.573127405391837 120 41.012221063533232;
createNode animCurveTL -n "camera1_translateZ";
	rename -uid "3D204D3C-4677-2313-DD73-A48054FD60FB";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 254.72795544545275 120 243.80029535866424;
createNode animCurveTA -n "camera1_rotateX";
	rename -uid "DC145447-49B1-F16A-ECB5-12BE920083B6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -30.599999999997383 120 -16.199999999996447;
createNode animCurveTA -n "camera1_rotateY";
	rename -uid "26717998-4024-FA8C-BADB-78ACAABB66DC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -93.599999999983638 120 -100.79999999998314;
createNode animCurveTA -n "camera1_rotateZ";
	rename -uid "4F9B581D-4B88-4030-90EE-5DA0297D49F6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;

...
//Name: Shot 39 001.ma
//Last modified: Fri, Dec 06, 2019 03:33:47 PM
//Codeset: 1252
...
createNode transform -n "camera1";
	...
	setAttr ".t" -type "double3" -61.306282368864181 13.227868007941993 50.346038451292031 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F12D32CE-4A61-BFAA-A2A7-308B8730FAD1";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "792B2D12-4CB9-B9F5-86BF-648DF7E1BC63";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0D347927-45C4-ED32-7360-6D8FD1EF941F";
createNode displayLayerManager -n "layerManager";
	rename -uid "B931184E-4F26-1D1F-66C6-6FA93C95F873";
createNode displayLayer -n "defaultLayer";
	rename -uid "A407C3C7-4578-2E46-9023-0D96CB853F1D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6DDDB523-4AC3-523F-AB69-5097C254F802";
...
createNode reference -n "ZillaRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 0 0 56.23575939389169065"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Legs_Controls|Zilla:L_Leg_Controls|Zilla:L_Leg_FK_Controls|Zilla:L_FK_Toe3_02_ctl_grp|Zilla:L_FK_Toe3_02_ctl" 
		"rotateZ" " -av"

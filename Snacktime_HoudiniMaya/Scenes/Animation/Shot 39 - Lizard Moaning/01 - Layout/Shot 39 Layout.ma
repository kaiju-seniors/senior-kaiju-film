...
//Last modified: Mon, Nov 18, 2019 02:13:16 PM
//Codeset: 1252
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9BF6E2B7-41C1-F971-9032-348B8E952A46";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3F25333A-49DF-27D0-C50B-9198034032BF";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "93E24149-4F46-7948-7BAB-448E2CEDFA2B";
createNode displayLayerManager -n "layerManager";
	rename -uid "3D51E018-499C-DEB0-946E-AA933403D1DA";
createNode displayLayer -n "defaultLayer";
	rename -uid "A407C3C7-4578-2E46-9023-0D96CB853F1D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DC2DE67E-4534-3948-8BB1-79B8014A7399";
...
createNode reference -n "ZillaRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -0.15492667077359193 3.29650892242684801 9.43698720802599489"
		...
		"rotate" " -type \"double3\" -6.0162016156491207 2.54737964977252851 3.03003632650504251"
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 87 -ast 1 -aet 120 ";
	setAttr ".st" 6;

...
//Last modified: Tue, Sep 17, 2019 05:52:14 PM
//Codeset: 1252
...
createNode transform -n "Main_Camera";
	...
	setAttr ".t" -type "double3" 54.416611019601348 19.557708788324508 37.399272271040431 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" -145.98342378226289 -0.012702544597485894 -180.00614065009458 ;
	setAttr -l on ".rx";
	setAttr -l on ".ry";
	setAttr -l on ".rz";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B8208BB1-49A3-70A3-C8AC-1794A6DD5C16";
	setAttr -s 84 ".lnk";
	setAttr -s 84 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BC6F8FBC-4897-2640-EE53-A7A65B82D0CA";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9E1F0FC7-439D-4C87-EB5D-F8A349A5F206";
createNode displayLayerManager -n "layerManager";
	rename -uid "3AA71E26-49B7-03A4-5B27-C9BD067639C9";
createNode displayLayer -n "defaultLayer";
	rename -uid "22E57F6B-4334-A0D4-5174-ABBBF08985D4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7664F279-499D-2F34-EE14-AA9678AC4538";

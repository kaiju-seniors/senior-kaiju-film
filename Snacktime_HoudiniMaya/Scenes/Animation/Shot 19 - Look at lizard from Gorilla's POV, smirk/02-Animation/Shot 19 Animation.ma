...
//Name: Shot 19 Animation.ma
//Last modified: Thu, Oct 10, 2019 01:54:42 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.68981759648068208 34.388138685369107 223.6675477085916 ;
	setAttr ".r" -type "double3" -14.738352729408154 174.59999999992604 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DAC345C1-4D9A-30C4-724C-1BBDDF63290B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 35.886761242733748;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "960A1833-43EF-1E49-A6F6-2E94E8161542";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3CF44879-4024-BC6C-12A7-899C5777E6D6";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DF4AE111-4597-FFB2-EBC3-5FBE8D9981EA";
createNode displayLayerManager -n "layerManager";
	rename -uid "8BE49E05-40B0-47C9-0714-1A89B3852F01";
createNode displayLayer -n "defaultLayer";
	rename -uid "A407C3C7-4578-2E46-9023-0D96CB853F1D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3C97820E-4EA9-C0B6-84E4-D0AD751B27F7";
...
createNode reference -n "ZillaRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -0.24731239115703829 0.011741745850299523 1.26044450629433413"
		...
		"translateZ" " -av"
		2 "|Zilla:Zilla|Zilla:Joints|Zilla:L_IK_FR_01_jnt|Zilla:L_IK_FR_02_jnt|Zilla:L_RK_Toe1_01_jnt1" 
		"rotate" " -type \"double3\" -9.81505157021072172 -36.7162397815127477 1.24106514596664863"
		...
		"translate" " -type \"double3\" 0 0 0"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Face_Controls|Zilla:Jaw_ctrl_grp|Zilla:Jaw_ctrl" 
		"rotate" " -type \"double3\" 0 0 12.03676179801100332"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Face_Controls|Zilla:Jaw_ctrl_grp|Zilla:Jaw_ctrl" 
		"rotateX" " -av"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Face_Controls|Zilla:Jaw_ctrl_grp|Zilla:Jaw_ctrl" 
		"rotateY" " -av"
		...
		" -type \"double3\" 1.38457887782618672 2.41031336720612988 0"
		...
		"translateZ" " -av"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Spine_Controls|Zilla:Neck_01_ctl_grp|Zilla:Neck_01_ctl" 
		"rotate" " -type \"double3\" -2.69265546089709007 -3.18538722609472247 -0.055635334327443026"
		...
		"translateZ" " -av"
		2 "|Zilla:Zilla|Zilla:Controls|Zilla:Spine_Controls|Zilla:Head_ctl_grp|Zilla:Head_ctl" 
		"rotate" " -type \"double3\" 1.38191995175674998 -2.59231678258549847 -8.45282175673714242"
...
createNode animCurveTA -n "R_FK_Arm_01_ctl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  -39 31.597303451414508 -31 31.597303451414508
		 -24 31.597303451414508 -11 31.597303451414508 0 31.597303451414508;
createNode animCurveTA -n "R_FK_Arm_01_ctl_rotateY";
	rename -uid "A3AA18FC-482E-9F91-5B21-228226526842";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  -39 33.28734603645465 -31 32.630282738970656
		 -24 34.246773372517922 -11 31.887985668040947 0 31.887985668040947;
createNode animCurveTA -n "R_FK_Arm_01_ctl_rotateZ";
	rename -uid "E1B39C26-4251-A256-54D2-13B2BED29C80";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  -39 15.154142019753884 -31 17.983291576565094
		 -24 12.782421495838637 -11 12.782421495838637 0 8.6503244175857397;
createNode animCurveTA -n "L_FK_Arm_01_ctl_rotateX";
	rename -uid "F17FEEA1-4935-386D-047A-B3A19D29998C";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  -39 -23.722026330632595 -31 -28.593341285110398
		 -22 -28.593341285110398 -11 -34.047156550359269 0 -27.674608232956349;
createNode animCurveTA -n "L_FK_Arm_01_ctl_rotateY";
	rename -uid "1D1BA89F-4179-5798-291D-0585D7A7F4C8";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  -39 -37.723215101318097 -31 -37.723215101318097
		 -22 -38.738753954777472 -11 -38.738753954777472 0 -38.738753954777472;
createNode animCurveTA -n "L_FK_Arm_01_ctl_rotateZ";
	rename -uid "D43329E5-4E31-AD9E-015D-919734AF7ECE";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  -39 -3.5416600338793915 -31 2.8954635795791739
		 -22 -10.941546814837752 -11 -10.941546814837752 0 -6.9167107966003263;
...
connectAttr "L_Mouth_ctrl_translateY.o" "ZillaRN.phl[4]";
connectAttr "L_Mouth_ctrl_translateX.o" "ZillaRN.phl[5]";
connectAttr "L_Mouth_ctrl_translateZ.o" "ZillaRN.phl[6]";
connectAttr "R_Mouth_ctrl_translateY.o" "ZillaRN.phl[7]";
connectAttr "R_Mouth_ctrl_translateX.o" "ZillaRN.phl[8]";
connectAttr "R_Mouth_ctrl_translateZ.o" "ZillaRN.phl[9]";
connectAttr "COG_ctl_translateX.o" "ZillaRN.phl[10]";
connectAttr "COG_ctl_translateY.o" "ZillaRN.phl[11]";
connectAttr "COG_ctl_translateZ.o" "ZillaRN.phl[12]";
connectAttr "Neck_01_ctl_rotateX.o" "ZillaRN.phl[13]";
connectAttr "Neck_01_ctl_rotateY.o" "ZillaRN.phl[14]";
connectAttr "Neck_01_ctl_rotateZ.o" "ZillaRN.phl[15]";
connectAttr "Neck_02_ctl_rotateX.o" "ZillaRN.phl[16]";
connectAttr "Neck_02_ctl_rotateY.o" "ZillaRN.phl[17]";
connectAttr "Neck_02_ctl_rotateZ.o" "ZillaRN.phl[18]";
connectAttr "Head_ctl_rotateX.o" "ZillaRN.phl[19]";
connectAttr "Head_ctl_rotateY.o" "ZillaRN.phl[20]";
connectAttr "Head_ctl_rotateZ.o" "ZillaRN.phl[21]";
connectAttr "R_Arm_IK_Handle_ctl_translateX.o" "ZillaRN.phl[22]";
connectAttr "R_Arm_IK_Handle_ctl_translateY.o" "ZillaRN.phl[23]";
connectAttr "R_Arm_IK_Handle_ctl_translateZ.o" "ZillaRN.phl[24]";
connectAttr "R_Arm_IK_Handle_ctl_rotateX.o" "ZillaRN.phl[25]";
connectAttr "R_Arm_IK_Handle_ctl_rotateY.o" "ZillaRN.phl[26]";
connectAttr "R_Arm_IK_Handle_ctl_rotateZ.o" "ZillaRN.phl[27]";
